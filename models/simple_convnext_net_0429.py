...
class ConvNeXtUNet(nn.Module):
    def __init__(self, in_channels=45, out_channels=40):
        ...
        # 编码器（下采样路径）
        self.stage1 = nn.Sequential(*[ConvNeXt_Block(64) for _ in range(2)])
        self.down1 = nn.Conv2d(64, 128, kernel_size=3, stride=2, padding=1)  # 480->240
        
        self.stage2 = nn.Sequential(*[ConvNeXt_Block(128) for _ in range(2)])
        ...
        self.stage4 = nn.Sequential(*[ConvNeXt_Block(128) for _ in range(2)])
        ...
        self.stage5 = nn.Sequential(*[ConvNeXt_Block(64) for _ in range(2)])
