"""
Ocean Reconstruction Model Inference Script (Glory mode — no SST/SSS/SLA)

The new model takes only the background subsurface fields (bg_t_3d + bg_s_3d)
...
# =============================================================================
# Data-index configuration  (NO surface variables)
# =============================================================================
# Surface variables intentionally empty – the new model does not use them.
SURFACE_VARS = [
...
def main():
    parser = argparse.ArgumentParser(
        description='Ocean Reconstruction Inference  (Glory mode – no SST/SSS/SLA)')
    ...
    parser.add_argument('--save_dir', type=str, default='./inference_glory_results',
